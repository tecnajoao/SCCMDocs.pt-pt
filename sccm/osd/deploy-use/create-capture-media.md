---
title: Criar suporte de dados de captura - Configuration Manager | Documentos do Microsoft
description: "Utilize o assistente suportes de dados da sequência de tarefas criar para criar suportes de dados de captura no Configuration Manager para capturar uma imagem de sistema operativo a partir de um computador de referência."
ms.custom: na
ms.date: 01/23/2017
...
---
# <a name="create-capture-media-with-system-center-configuration-manager"></a>Criar suporte de dados captura com o System Center Configuration Manager
...
-   [Criar uma sequência de tarefas para capturar uma sistemas operativos](create-a-task-sequence-to-capture-an-operating-system.md)  
