...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **imagens**e selecione **aplicar imagem de dados**. 
...
Selecione **navegue** para especificar a **pacote de imagem** utilizado por esta sequência de tarefas. Selecione o pacote que pretende instalar na caixa de diálogo **Selecionar um Pacote**. Na parte inferior da caixa de diálogo apresenta as informações de propriedade associada para cada pacote de imagem existente. Utilize a lista pendente para selecionar a **Imagem** que pretende instalar a partir do **Pacote de Imagem** selecionado.  
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **controladores**e selecione **aplicar pacote de controlador**. 
...
Especifique o pacote de controladores que contém os controladores de dispositivo necessários. Selecione **navegue** para iniciar o **selecionar um pacote** caixa de diálogo. Selecione um pacote de controladores existente para aplicar. Na parte inferior da caixa de diálogo apresenta as propriedades do pacote associado.  
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **definições**e selecione **aplicar definições de rede**. 
...
Selecione **definir** para especificar uma conta com as permissões necessárias para associar o computador ao domínio. Na **conta de utilizador do Windows** caixa de diálogo, introduza o nome de utilizador no seguinte formato: `Domain\User`. Para obter mais informações, consulte [domínio de conta de adesão ao](/sccm/core/plan-design/hierarchy/accounts#task-sequence-editor-domain-joining-account). 

#### <a name="adapter-settings"></a>Definições da placa  
Especifique as configurações de rede para cada placa de rede no computador. Selecione **New** para abrir o **as definições de rede** diálogo caixa e, em seguida, especifique as definições de rede. 
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **imagens**e selecione **Apply Operating System Image**. 
...
Instala uma imagem de SO que capturou. Selecione **navegue** para abrir o **selecionar um pacote** caixa de diálogo. Em seguida, selecione o pacote de imagem existente que pretende instalar. Se várias imagens estão associadas a especificado **pacote de imagem**, selecione na lista pendente a imagem associada a utilizar para esta implementação. Pode ver informações básicas sobre cada imagem existente ao selecioná-la.  
...
Instala um sistema operacional com um pacote de atualização de SO, que também é uma origem de instalação original. Selecione **navegue** para abrir o **selecione um pacote de atualização do sistema operativo** caixa de diálogo. Em seguida, selecione o pacote de atualização SO existente que pretende utilizar. Pode ver informações básicas sobre cada origem de imagem existente ao selecioná-la. O painel de resultados na parte inferior da caixa de diálogo apresenta as propriedades da origem de imagem associado. Se existirem várias edições associadas ao pacote especificado, utilize a lista pendente para selecionar o **Edition** que pretende utilizar.  
...
> 
> Implementar novas instalações do Windows via **pacotes de atualização do sistema operativo** é ainda suportado, mas é dependentes nos drivers a ser compatível com este método. Quando o pacote de atualização do Windows a instalar a partir de um sistema operacional, drivers são instalados ainda no Windows PE versus simplesmente, que é injetado no Windows PE. Alguns drivers não são compatíveis com a ser instalado no Windows PE.
> 
> Se os drivers não são compatíveis com a ser instalado no Windows PE, em seguida, criar uma **imagem do sistema operativo** com o **Install. wim** dos arquivos de origem de instalação original. Em seguida, implementar através do **aplicar sistema operativo a partir de uma imagem capturada** opção em vez disso.
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **definições**e selecione **aplicar definições do Windows**. 
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **controladores**e selecione **aplicar controladores automaticamente**. 
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **definições**e selecione **capturar definições de rede**. 
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **imagens**e selecione **Capture Operating System Image**. 
...
Introduza a conta do Windows que tem permissões para a partilha de rede especificada. Selecione **definir** para especificar o nome da conta do Windows.  
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **estado do utilizador**e selecione **capturar estado do utilizador**. 
...
Selecione esta opção para especificar um ficheiro de perfil personalizado para a migração. Selecione **ficheiros** para selecionar os ficheiros de configuração para o USMT utilizar neste passo. Especifique um ficheiro. XML personalizado que contém as regras que definem os ficheiros de estado do utilizador a migrar.  

#### <a name="click-here-to-select-configuration-files"></a>Clique aqui para selecionar ficheiros de configuração
Selecione esta opção para selecionar os ficheiros de configuração no pacote do USMT que pretende utilizar para capturar os perfis de utilizador. Selecione o **arquivos** botão para iniciar o **ficheiros de configuração** caixa de diálogo. Para especificar um ficheiro de configuração, introduza o nome do ficheiro na **Filename** e selecionar o **Add** botão.  
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **definições**e selecione **capturar definições do Windows**. 
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **gerais**e selecione **verificar disponibilidade**. 
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **gerais**e selecione **Connect To Network Folder**. 
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **discos**e selecione **desativar BitLocker**. 
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **Software**e selecione **transferir conteúdo do pacote**. 
...
Selecione o ícone para escolher o pacote a transferir. Depois de escolher um pacote, selecione o ícone novamente para escolher outro.  
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **discos**e selecione **ativar BitLocker**. 
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **discos**e selecione **formatar e particionar disco**. 
...
Para criar uma nova partição, selecione **New** para iniciar o **propriedades de partição** caixa de diálogo. Especificar o tipo de partição e o tamanho, e se é uma partição de arranque. Para modificar uma partição existente, selecione a partição que pretende modificar e, em seguida, selecione o **propriedades** botão. Para obter mais informações sobre como configurar partições de disco rígido, consulte um dos seguintes artigos:  
...
Para eliminar uma partição, selecione a partição e, em seguida, selecione **eliminar**.  
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **Software**e selecione **instalar aplicação**. 
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **Software**e selecione **Instalar pacote**. 
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **gerais**e selecione **associar domínio ou grupo de trabalho**. 
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **imagens**e selecione **preparar ConfigMgr Client para captura**. 
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **imagens**e selecione **preparar Windows para captura**. 
...
A partir da versão 1810, este passo é utilizado no [Windows Autopilot para dispositivos existentes](/sccm/osd/deploy-use/windows-autopilot-for-existing-devices) sequência de tarefas.

- Se pretender que a sequência de tarefas para atualizar o dispositivo e, em seguida, começar de imediato OOBE para Autopilot, deixe esta opção.  

- Ative esta opção para encerrar o dispositivo após a geração de imagens. Em seguida, pode entregar o dispositivo a um utilizador, o que é iniciado OOBE com Autopilot quando eles a ativá-lo pela primeira vez.  
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **discos**e selecione **provisão prévia do BitLocker**. 
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **estado do utilizador**e selecione **versão Estado Store**. 
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **estado do utilizador**e selecione **Store de estado do pedido**. 
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **gerais**e selecione **reiniciar o computador**. 
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **estado do utilizador**e selecione **restaurar estado do utilizador**. 
...
Permite personalizar os ficheiros que pretende restaurar para o computador de destino. Selecione **ficheiros** para especificar os ficheiros de configuração no pacote do USMT que pretende utilizar para restaurar os perfis de utilizador. Para adicionar um ficheiro de configuração, introduza o nome do arquivo na **Filename** caixa e, em seguida, selecione **Add**. O painel de ficheiros lista os ficheiros de configuração que utiliza a USMT. O ficheiro. XML especificado define o ficheiro de utilizador restaura do USMT.  
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **gerais**e selecione **executar linha de comandos**. 
...
#### <a name="account"></a>Conta
Especifica a conta de utilizador do Windows que este passo utiliza para executar a linha de comandos. A linha de comando é executado com as permissões da conta especificada. Selecione **definir** para especificar a conta de utilizador ou domínio local. Para obter mais informações sobre a conta sequência de tarefas executar como, consulte [contas](/sccm/core/plan-design/hierarchy/accounts#task-sequence-run-as-account).
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **gerais**e selecione **executar Script do PowerShell**. 
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **gerais**e selecione **executar a sequência de tarefas**. 


### <a name="specifications-and-limitations"></a>Especificações e limitações
...
- Não é possível selecionar uma sequência de tarefas com uma referência de imagem de arranque. Para qualquer implementação que requer uma imagem de arranque, especificá-lo sobre a sequência de tarefas do pai.  

- Se uma sequência de tarefas filho estiver desativada, a implementação falhar. Não é possível utilizar o **continuar com o erro** opção para contornar esta limitação.  

- Se uma sequência de tarefas filho contém passos que são considerados *elevado impacto*, Centro de Software não detetá-lo e mostrar a notificação de alto impacto. Modificar as propriedades da sequência de tarefas principal, no separador de notificação do utilizador, para especificar que **esta é uma sequência de tarefas de alto impacto**.  

- Se uma sequência de tarefas filho tem uma referência de pacote em falta, ver a sequência de tarefas de principal não Deteta esse Estado. Se editar a sequência de tarefas do pai, Deteta quaisquer referências em falta nas sequências de tarefas de subordinado quando fizer alterações ao principal.  
...
Selecione **procurar** para selecionar a sequência de tarefas filho. O **Selecione uma sequência de tarefas** caixa de diálogo não apresenta a sequência de tarefas do pai.
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **gerais**e selecione **definir variáveis dinâmicas**. 
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **gerais**e selecione **Set Task Sequence Variable**. 
...
> [!Note]  
> Ative esta opção e, em seguida, defina o valor da variável de sequência de tarefas. Caso contrário, o valor da variável não estiver definido como pretende, o que pode causar comportamentos inesperados quando a sequência de tarefas é executada.<!--SCCMdocs issue #800--> 
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **imagens**e selecione **configuração do Windows e ConfigMgr**. 
...
Selecione **procurar**, em seguida, escolha o Gestor de configuração do pacote de instalação de cliente para utilizar neste passo.  

#### <a name="use-pre-production-client-package-when-available"></a>Utilizar o pacote de cliente de pré-produção quando disponível
Se existir um pacote de cliente de pré-produção disponível, e o computador for um membro da coleção piloto, a sequência de tarefas utiliza este pacote em vez do pacote de cliente de produção. O cliente de pré-produção é uma versão mais recente para um teste num ambiente de produção. Selecione **procurar**, em seguida, escolha a pré-produção pacote de instalação de cliente para utilizar neste passo.  
...
Para adicionar este passo no editor de sequência de tarefas, selecione **Add**, selecione **imagens**e selecione **atualizar sistema operativo**. 
...
- **Pacote de controladores**: Selecione **procurar** e escolha um pacote de controlador existente na lista.  
