...
- Pode instalar diretamente a partir de CDs sem colocar todos os pacotes de software (incluindo o Windows em si) num pacote do Configuration Manager.  
...
-   **Sistema operativo a implementar**  
     ...
     O sistema operativo que pretende implementar nos computadores de destino tem de estar instalado no computador de referência. Para obter mais informações sobre os sistemas operativos que pode implementar, veja [requisitos de infraestrutura para implementação do sistema operativo](../plan-design/infrastructure-requirements-for-operating-system-deployment.md).  
...
-   **Ferramentas e scripts necessários para atenuar os cenários de instalação adequados**  

     Ferramentas e scripts adequados necessários para atenuar os cenários de instalação  

-   **Personalização de ambiente de trabalho adequada, tais como o fundo, imagem corporativa e perfil de usuário padrão**  
...
> [!NOTE]  
>  Ao criar manualmente o computador de referência, poderá capturar a imagem do sistema operativo utilizando um suporte de dados de captura. Para obter mais informações, consulte [criar suporte de dados de captura](../deploy-use/create-capture-media.md).  
