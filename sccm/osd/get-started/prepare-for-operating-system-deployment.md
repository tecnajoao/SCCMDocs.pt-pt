---
title: "Preparar a implementação do sistema operativo | Documentos do Microsoft"
description: "Leia os seguintes artigos para saber mais sobre o que deve fazer no Configuration Manager para se preparar para implementações do sistema operativo."
ms.custom: na
ms.date: 10/06/2016
...
-   [Gerir imagens do sistema operativo](manage-operating-system-images.md)  
...
-   [Preparar para implementações de computadores desconhecidos](prepare-for-unknown-computer-deployments.md)  

-   [Associar utilizadores um computador de destino](associate-users-with-a-destination-computer.md)  
