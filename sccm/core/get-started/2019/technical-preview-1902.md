---
title: Pré-visualização técnica 1902
titleSuffix: Configuration Manager
description: Saiba mais sobre novas funcionalidades disponíveis no Configuration Manager versão de ramificação de pré-visualização técnica 1902.
ms.date: 02/08/2019
...
ms.locfileid: "55972096"
---
# <a name="features-in-configuration-manager-technical-preview-version-1902"></a>Recursos do Configuration Manager technical preview versão 1902

*Aplica-se a: O System Center Configuration Manager (pré-visualização técnica)*

Este artigo apresenta os recursos que estão disponíveis no technical preview no Configuration Manager, versão 1902. Instale esta versão para atualizar e adicionar novas funcionalidades para o seu site de pré-visualização técnica. 
