...
description: Saiba mais sobre novas funcionalidades disponíveis no Configuration Manager versão de ramificação de pré-visualização técnica 1901.
ms.date: 01/23/2019
...
ms.locfileid: "56136590"
---
# <a name="features-in-configuration-manager-technical-preview-version-1901"></a>Recursos do Configuration Manager technical preview versão 1901

*Aplica-se a: O System Center Configuration Manager (pré-visualização técnica)*

Este artigo apresenta os recursos que estão disponíveis no technical preview no Configuration Manager, versão 1901. Instale esta versão para atualizar e adicionar novas funcionalidades para o seu site de pré-visualização técnica. 
