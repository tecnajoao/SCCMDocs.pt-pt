...
-   **Windows 10**: Pro, Enterprise  
   Consulte [suporte para versões do Windows 10](/sccm/core/plan-design/configs/support-for-windows-10) para obter detalhes sobre os diferentes lançamento de versões do Windows 10 que são suportadas por versões diferentes do Configuration Manager.
