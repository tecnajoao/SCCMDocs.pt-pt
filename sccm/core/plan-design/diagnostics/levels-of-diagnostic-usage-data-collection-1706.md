...
System Center Configuration Manager versão 1706 recolhe três níveis de diagnósticos e dados de utilização: **Básica**, **avançada**, e **completa**. Por predefinição, esta funcionalidade está definida no nível Avançado. As secções seguintes fornecem detalhes adicionais sobre os dados que recolhe de cada nível.
...
- ***[Atualizado]***  Informações de servidor para sistema de site básico (funções de sistema de sites utilizadas, estado de Internet e o SSL, sistema operativo, processadores, físico ou máquina virtual e utilização elevada de disponibilidade no servidor do site)
...
- ***[Novo]***  Hashed lista de extensões para os assistentes e páginas de propriedades de consola de administração
...
- **Gestão de aplicações:**  
   ...
   - ***[Novo]***  Contagem de imagem corporativa distintas do catálogo de aplicações

   - ***[Novo]***  Criadas usando o dashboard de aplicações de contagem do Office 365
   ...
   - ***[Novo]***  Tipos de implementação de contagem do Windows Installer por definições de conteúdo de desinstalação
...
- **Serviços cloud:**
  ...
  - ***[Atualizado]***  Estatísticas de utilização e configuração do Gateway de gestão na Cloud, incluindo contagens de regiões e ambientes e estatísticas de autenticação/autorização
...
- **Conteúdo:**  
    ...
    - ***[Atualizado]***  Contagem de clientes de cache ponto a ponto, estatísticas de utilização e estatísticas de transferência parcial
...
- **Implementação do sistema operativo:**  
    ...
    - ***[Novo]***  Contagem de implementações de sequência de tarefas usando a opção para pré-transferir conteúdo
...
- **Atualizações de Software:**  
    ...
    - ***[Novo]***  Drivers de contagem do Microsoft Surface sincronizados
    ...
    - ***[Novo]***  Contagem do Windows Update para políticas de negócios criados e implementados
...
- ***[Novo]***  Estatísticas de política de conformidade em conformidade e erros
