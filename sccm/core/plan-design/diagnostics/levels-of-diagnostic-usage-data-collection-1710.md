...
description: Saiba mais sobre os níveis de diagnósticos e dados de utilização recolhe versão 1710 do System Center Configuration Manager.
ms.date: 11/20/2017
...
System Center Configuration Manager versão 1710 recolhe três níveis de diagnósticos e dados de utilização: **Básica**, **avançada**, e **completa**. Por predefinição, esta funcionalidade está definida no nível Avançado. As secções seguintes fornecem detalhes adicionais sobre os dados que recolhe de cada nível.
...
- Estatísticas de deteção básica (deteção contagem máximo/mínimo/médio grupo tamanhos e) incluindo quando o site está em execução inteiramente com os serviços do Active Directory do Azure.
...
- Informações de servidor para sistema de site básico (funções de sistema de sites utilizadas, estado de Internet e o SSL, sistema operativo, processadores, físico ou máquina virtual e utilização elevada de disponibilidade no servidor do site)
...
- ***[Atualizado]***  Versões de cliente de contagem do Configuration Manager, versões de sistemas operativos e versões do Office
...
- **Gestão de aplicações:**  
   ...
   - Contagem da Microsoft Store para aplicações de negócio e as estatísticas de sincronização (incluindo resumidos tipos de aplicações, licenciado o estado de aplicações e aplicações licenciadas do número de online e offline)  
...
- **Cliente:**  
   ...
   - Estatísticas de atestado de estado de funcionamento do dispositivo incluindo códigos de erro mais comuns, número de servidores no local e contagens de dispositivos em vários Estados.
...
- **Serviços cloud:**
  ...
  - Estatísticas de utilização e configuração do Gateway de gestão na Cloud, incluindo contagens de regiões e ambientes e estatísticas de autenticação/autorização

  - Contagem do Azure Active Directory aplicações e serviços ligados para o Configuration Manager

  - Contagem de clientes associados ao Azure Active Directory Services
...
- ***[Novo]***  Cogestão
  - ***[Novo]***  Agregados estatísticas de utilização de cogestão incluindo o número de clientes inscritos, clientes que recebem a política, Estados de carga de trabalho, tamanhos de coleção piloto/exclusão, erros de inscrição
  - ***[Novo]***  Contagem de clientes por método de inscrição de cogestão
  - ***[Novo]***  Estatísticas de erros de inscrição de cogestão
  - ***[Novo]***  Agenda de inscrição e estatísticas históricas
  - ***[Novo]***  Contagem de clientes elegíveis para a cogestão
...
- **Endpoint Protection:**  
   ...
   - ***[Novo]***  Contagem do Windows Defender Exploit Guard políticas, implementações e os clientes de destinados
...
- **Implementação do sistema operativo:**  
    ...
    - ***[Novo]***  Implementação de contagem de sistema operacional pela versão do SO

    - ***[Novo]***  Contagem de SO é atualizado ao longo do tempo
...
- Microsoft Store para detalhes de aplicativo de negócios (não é de agregação lista de aplicativos sincronizados, incluindo AppID, o estado online ou o estado offline e contagens de licenças adquiridas total)
