...
O Configuration Manager versão 1802 recolhe três níveis de diagnósticos e dados de utilização: **Básica**, **avançada**, e **completa**. Por predefinição, esta funcionalidade está definida no nível Avançado. As secções seguintes fornecem detalhes adicionais sobre os dados recolhidos em cada nível.
...
- Estatísticas de telemetria: quando executado, tempo de execução, erros

- Se a deteção de rede está ativada ou desativada

- ***[Movido]***  Contagem de clientes associados ao Azure Active Directory

- ***[Novo]***  Contagem de implementações faseadas criado por tipo
...
### <a name="application-management"></a>Gestão de aplicações  
   ...
   - ***[Novo]***  Máx e média de utilizadores primários por dispositivo
...
### <a name="client"></a>Cliente  
   ...
   - ***[Novo]***  Contagem de dispositivos por browser predefinido
...
### <a name="content"></a>Conteúdo  
  ...
  - ***[Atualizado]***  Estatísticas de grupo de limites: quantos mais rápidas e quantos lento, contagem por grupo e relações de contingência
...
### <a name="software-updates"></a>Atualizações de Software  
   ...
   - ***[Novo]***  Agregados estatísticas de atualização do Windows para configurações de negócios
...
### <a name="miscellaneous"></a>Diversos  
   ...
   - ***[Novo]***  Faseada estatísticas de utilização de implementação
