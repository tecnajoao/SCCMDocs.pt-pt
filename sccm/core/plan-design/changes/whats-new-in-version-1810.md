---
title: O que há de novo na versão 1810
...
### <a name="an-intune-connection-is-no-longer-required-for-on-premises-mdm"></a>Uma ligação do Intune já não é necessária para MDM no local
