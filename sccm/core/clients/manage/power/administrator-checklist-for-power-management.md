---
title: "Lista de verificação de administrador para gestão de energia | Documentos do Microsoft"
...
|Tarefa|Detalhes|  
|----------|-------------|  
|Rever os conceitos de gestão de energia na biblioteca de documentação do Configuration Manager.|Consulte o artigo [introdução à gestão de energia](introduction-to-power-management.md).|  
|Reveja os pré-requisitos de gestão de energia na biblioteca de documentação do Configuration Manager.|Consulte o artigo [pré-requisitos para gestão de energia](prerequisites-for-power-management.md).|  
|Reveja as informações relativas às melhores práticas para a gestão de energia.|Consulte o artigo [melhores práticas para gestão de energia](best-practices-for-power-management.md).|  
|Configure coleções para gerir o consumo de energia a partir de computadores no seu ambiente.|Utilize o **coleção para relatórios de dados de linha de base**, **coleção para relatórios de dados da linha base**, **coleção de computadores sem capacidade de gestão de energia**, **coleções de computadores a que potência planos serão aplicados**, **coleções de computadores a que potência planos serão aplicados**, e **coleções de computadores que executem Windows Server** para o ajudar a gerir as definições de energia para computadores da sua hierarquia. Pode criar várias coleções e aplicar diferentes esquemas de energia a cada coleção.|  
|Ativar a gestão de energia.|Antes de poder começar a utilizar a gestão de energia, tem de ativá-la e configurar as definições de cliente necessárias. Para obter mais informações, consulte o artigo [configurar gestão de energia](configuring-power-management.md).|  
|Recolha informações de gestão de energia dos computadores cliente.|Dados de gestão de energia são reportados pelos clientes através de inventário de hardware do Configuration Manager. Consoante a agenda de inventário de hardware que tiver configurado, poderá demorar algum tempo para obter o inventário de todos os computadores cliente.|  

## <a name="monitoring-and-planning-phase"></a>Fase de monitorização e planeamento  

|Tarefa|Detalhes|  
|----------|-------------|  
|Executar o relatório **Atividade do Computador**.|O relatório **Atividade do Computador** mostra um gráfico com a atividade do monitor, computador e utilizador numa coleção especificada e num período de tempo especificado. Este relatório contém ligações para o relatório **Detalhes da Atividade do Computador** , que apresenta as capacidades de suspensão e reativação dos computadores na coleção especificada. Para obter mais informações, consulte o artigo [como a monitorizar e planear a gestão de energia](monitor-and-plan-for-power-management.md).|  
...
|Executar o relatório **Capacidades de Energia**.|O relatório **Capacidades de Energia** mostra as funcionalidades de gestão de energia dos computadores na coleção especificada. Para obter mais informações, consulte o artigo [como a monitorizar e planear a gestão de energia](monitor-and-plan-for-power-management.md).|  
...
|Exclua todas as coleções de computadores necessárias da gestão de energia.|Consulte o artigo [configurar gestão de energia](configuring-power-management.md).|  
...
|Tarefa|Detalhes|  
|----------|-------------|  
|Selecionar esquemas de energia existentes ou crie esquemas novos para coleções de computadores na sua organização.|Consulte o artigo [como criar e aplicar os esquemas de energia](create-and-apply-power-plans.md).|  
|Aplicar estes esquemas de energia aos computadores.|Consulte o artigo [como criar e aplicar os esquemas de energia](create-and-apply-power-plans.md).|  
