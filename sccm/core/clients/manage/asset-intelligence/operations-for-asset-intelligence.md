...
description: Executar tarefas comuns de Asset Intelligence no System Center Configuration Manager.
ms.date: 2/22/2017
...
Este tópico contém informações para ajudar a gerir as tarefas típicas de Asset Intelligence na sua hierarquia do System Center Configuration Manager:  
...
- **Sincronização do catálogo**: Fornece informações sobre se o Asset Intelligence está ativado, o estado atual do ponto de sincronização do Asset Intelligence, a agenda de sincronização, se a declaração de licença de cliente é importada, quando os estado foi atualizado pela última vez e a hora para a próxima atualização agendada e o número de alterações que ocorreram após o ponto de sincronização do Asset Intelligence foi instalado o sistema de sites.  
...
###  <a name="BKMK_AssetIntelligenceReports"></a> Relatórios do Asset Intelligence  
 Existem mais de 60 relatórios do Asset Intelligence que apresentam as informações recolhidas pelo Asset Intelligence. Muitos destes relatórios incluem uma ligação para relatórios mais específicos nos quais pode consultar informações gerais e desagregar para obter informações mais detalhadas. Relatórios do Asset Intelligence estão localizados na consola do Configuration Manager, na **monitorização** área de trabalho, sob o **relatórios** nó. Os relatórios fornecem informações sobre hardware, gestão de licenças e software. Para obter mais informações sobre os relatórios no Configuration Manager, consulte [relatórios no System Center Configuration Manager](../../../../core/servers/manage/reporting.md).  
...
4. Na página **Geral** , introduza as seguintes informações:  
   ...
   2. **Estado de validação**: Indica o estado de validação como **definido pelo utilizador** para os requisitos de hardware. Não é possível modificar esta definição.  
   ...
   5. **Espaço mínimo em disco (KB)**: Especifica o espaço de espaço livre em disco mínimo, em KB, necessário ao título de software.  
...
5. Reveja as seguintes informações:  
   ...
   -   **Valor local**: Especifica as informações de categorização de software existentes no catálogo do Asset Intelligence que está em conflito com os detalhes de categorização software System Center Online mais recentes.  
...
6. Selecione uma das seguintes definições para resolver o conflito de detalhes de software:  
   ...
   - **Não altere o valor de informações do catálogo localmente editado**: Resolve o conflito de detalhes de software ao manter as existentes informações de categorização de software do catálogo do Asset Intelligence. Quando seleciona esta definição, o estado do título de software é alterado de **Atualizável** para **Definido pelo Utilizador**.  

   - **Substituir o valor de informações do catálogo localmente editado com o valor do System Center Online transferido**: Resolve o conflito de detalhes de software ao substituir as existentes informações de categorização de software do catálogo do Asset Intelligence pelas novas informações obtidas do System Center Online. Quando seleciona esta definição, o estado do título de software é alterado de **Atualizável** para **Validado**.  
