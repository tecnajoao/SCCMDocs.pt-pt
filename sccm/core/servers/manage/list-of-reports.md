...
|Nome do Relatório|Descrição|  
|-----------------|-----------------|  
|**Detalhes de Estados de firmware em dispositivos**|Apresenta os detalhes de Estados de UEFI, SecureBoot e TPM. **Nota**: Este relatório não está na versão 1810.<!--SCCMDocs issue #1189-->|  
