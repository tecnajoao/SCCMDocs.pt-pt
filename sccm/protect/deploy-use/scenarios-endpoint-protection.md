...
|O João examina as definições da política antimalware predefinida, a qual contém definições de segurança recomendadas pela Microsoft. Para os computadores fazerem uma análise rápida diária, altera as seguintes definições:<br /><br /> 1) **executar uma análise rápida diária nos computadores cliente**: **Sim**.<br /><br /> 2) **agendar hora da análise rápida diária**:  **9:00**.<br /><br /> O João repara que a opção **Atualizações distribuídas do Microsoft Update** está selecionada como origem de atualização de definições por predefinição, Isso cumpre o requisito de negócio que os computadores transferem definições do Microsoft Update quando não conseguirem receber atualizações de software do Configuration Manager.|Ver [como criar e implementar políticas antimalware do Endpoint Protection no System Center Configuration Manager](endpoint-antimalware-policies.md).|  
