---
title: Resolução de problemas do cliente do Windows Defender ou o Endpoint Protection
...
-   [Iniciar o serviço Windows Defender ou Endpoint Protection](#starting-windows-defender-or-endpoint-protection-service)  
...
##  <a name="update-windows-defender-or-endpoint-protection"></a>Atualizar o Windows Defender ou Endpoint Protection  
...
3.  Para repor a definição de tempo ou de data do seu computador, siga os passos em [corrigir atalhos de área de trabalho quebrados e de sistema comuns de tarefas de manutenção](http://go.microsoft.com/fwlink/?LinkId=155579) (http://go.microsoft.com/fwlink/?LinkId=155579).  

### <a name="step-4-rename-the-software-distribution-folder-on-your-computer"></a>Passo 4: Renomeie a pasta de distribuição de Software no seu computador  
...
4.  Abra o Windows Defender ou  
          Endpoint Protection, clique nas **atualização** separador e, em seguida, clique em **atualização**.  
...
-   Se estiver a executar um sistema de operativo do Windows de 32 bits, transfira as atualizações mais recentes manualmente em [ http://go.microsoft.com/fwlink/?LinkID=87342 ](http://go.microsoft.com/fwlink/?LinkID=87342) (http://go.microsoft.com/fwlink/?LinkID=87342).  

-   Se estiver a executar um sistema de operativo do Windows de 64 bits, transfira as atualizações mais recentes manualmente em [ http://go.microsoft.com/fwlink/?LinkID=87341 ](http://go.microsoft.com/fwlink/?LinkID=87341) (http://go.microsoft.com/fwlink/?LinkID=87341).  
 ...
 **Sintoma**  
 ...
 Receberá uma mensagem notificando-o de que **Windows Defender ou o Endpoint Protection não está a monitorizar o computador porque o serviço do programa parou. Deve reiniciá-lo agora.** 
...
### <a name="step-2-make-sure-the-windows-defender-or-endpoint-protection-service-is-set-to-automatic-and-is-started"></a>Passo 2: Certificar-se de que o "Windows Defender" ou "Serviço de proteção de ponto final" é definido como automático e é iniciado  
...
### <a name="step-3-remove-any-existing-internet-security-programs"></a>Passo 3: Remover quaisquer programas de segurança de Internet existentes  
...
> [!CAUTION]  
>  Quando remove programas de segurança da Internet, o seu computador fica desprotegido. Se tiver problemas ao instalar   
>       Proteção de ponto final após a remoção de programas de segurança de Internet existentes, entre em contato com o Windows Defender ou  
>       Suporte para proteção de ponto final ao submeter um incidente online (para obter mais informações, consulte [como submeter um incidente Online](http://www.microsoft.com/en-ph/security_essentials/Support/8c9074b6-1558-4d14-bc39-d294ced11096.aspx)).  
...
##  <a name="detected-threat-cant-be-remediated"></a>Não é possível remediar a ameaça detetada  
 Quando o Windows Defender ou o Endpoint Protection Deteta uma potencial ameaça que esteja oculta dentro de um ficheiro comprimido com uma extensão de nome de ficheiro. zip ou numa partilha de rede, este tenta lidar com a ameaça os colocar em quarentena ou removendo a ameaça.  
...
4.  Clique em **começar** e procure **linha de comandos**. Clique com o botão direito do rato em **Linha de Comandos**e, em seguida, clique em **Executar como administrador**.  
...
### <a name="step-3-start-windows-in-selective-startup-mode"></a>Passo 3: Iniciar o Windows no modo de arranque Seletivo  
