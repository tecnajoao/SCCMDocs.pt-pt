...
Para garantir que o canal de atualização está definido para que as atualizações implantadas irão ser detetadas corretamente, utilize um dos seguintes métodos:
