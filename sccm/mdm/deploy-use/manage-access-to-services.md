...
### <a name="see-also"></a>Consulte também  
 ...
 [Introdução às definições de conformidade no System Center Configuration Manager](../../compliance/get-started/get-started-with-compliance-settings.md)
