---
title: "Segurança e privacidade para as definições de compatibilidade | Documentos do Microsoft"
...
---
# <a name="security-and-privacy-for-compliance-settings-in-system-center-configuration-manager"></a>Segurança e privacidade para as definições de compatibilidade no System Center Configuration Manager
...
|Proteja o canal de comunicação ao navegar para um computador de referência.|Para impedir a adulteração dos dados quando é transferido através da rede, utilize Internet Protocol security (IPsec) ou bloco de mensagem de servidor (SMB) entre o computador que executa a consola do Configuration Manager e o computador de referência.|  
